...
pub use client::{
    ...
    FastForwardOutcome, GitClient, MergeResult, RebaseOutcome, SignatureCheck, StatusEntry,
    StatusKind, WorkspaceRecoveryStash, WorktreeInfo, bare_origin_path, clone_loom_workspace,
