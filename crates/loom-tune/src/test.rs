...
mod tests {
    ...
    use loom_protocol::gate::FindingValidator;
    ...
    use crate::evidence::{
        Item, ItemId, RootKind, RootReport, Snapshot, SplitMetadata, TextEvidence,
    };
        ...
        let evidence = Snapshot {
            ...
            selection: vec![Item::harvested(
                ...
                TextEvidence {
                    ...
                    relative_path: PathBuf::from("review.jsonl"),
                    body: "selection evidence".to_owned(),
                },
            )],
